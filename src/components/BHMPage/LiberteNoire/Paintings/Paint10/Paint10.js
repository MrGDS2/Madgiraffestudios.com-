...
const Paint10 = () => {
  ...
  ReactGA.pageview('/LiberteNoire/LiberteNoire');

  firebase.database().ref("LiberteNoire").once("value", snapshot => {
        ...
        <FadeIn>
          <div className="container ">
            ...
            <div className="row mt-5 pb-5">
              ...
              <div className="col-4" >
                <img src={image} id="noir-long" alt="main-img" />
              </div>
              <div className="col-3">
