...
const Paint4 = () => {
  ...
  ReactGA.pageview('/LiberteNoire/IGotYou');

  firebase.database().ref("Together").once("value", snapshot => {
        ...
        <FadeIn>
          <div className="container ">
            ...
            <div className="row mt-5 pb-5">
              <div className="col-5">
                <h1 className="align-me font-weight-bold p-3 secondary-color" >
                  {name}
                </h1>
              </div>
              <div className="col-4" >
