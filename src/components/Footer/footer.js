            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className=" col-md-4 text-center">
                        <div className="row">
                            <div className="col-md-3 mb-2">
                                <SocialIcon url="https://www.instagram.com/madgiraffestudios/" bgColor="#8d18b4"/>
                            </div>
                            <div className="col-md-3 mb-2">
                                <SocialIcon url="https://twitter.com/MadGiraffeStud1" bgColor="#8d18b4" />
                            </div>
                    ...
                    <div className="row">
                            ...
                            <span className="text-center"><p className="copyright text-muted">©2022 by <a href="https://github.com/MrGDS2">MrGDS2</a></p></span>
